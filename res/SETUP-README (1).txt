...
---->CLicking on the "Get Composition" menu option allows the user to see the contents of the portfolio by asking the user for the portfolio name in the form of a Dropdown menu, where the user will have to choose the portfolio.
